@if ($universalBundle)
    <div class='bg-white border border-gray-200 rounded-lg shadow-sm mb-4'>
        <div class="bg-white border-0 pt-4 px-6 pb-6">
            <div class="flex flex-col md:flex-row">
                ...
                <div class="flex-1 md:pr-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <span class="text-lg font-semibold text-gray-900 mb-0">{{ $universalBundle->getName() }}</span>
                            ...
                            <div class="mt-2">
                                @if ($fetchSetting?->license_type)
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">{{ $fetchSetting->license_type }}</span>
                                    @if (str_contains($fetchSetting->license_type, 'Regular'))
                                        <a href="{{ \Froiden\Envato\Helpers\FroidenApp::buyExtendedUrl(config(strtolower($universalBundle->getName()) . '.envato_item_id')) }}"
                                            target="_blank" class="ml-2 text-blue-600 hover:text-blue-800 font-medium">Upgrade now</a>
                                    @endif
                                @endif
                                ...
                                @if (
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">Support Expired</span>
                                @endif
                ...
                <div class="flex items-center justify-end mt-4 md:mt-0">
                                ...
                                <div class="mt-3 flex items-center justify-end">
                                    ...
                                    {{-- <div class="custom-control custom-switch ml-2 d-inline-block"  data-toggle="tooltip"
                                        ...
                                        <input type="checkbox" class="custom-control-input change-module-notification"
                                            ...
                                            id="module-notification-{{ $universalBundle->getName() }}" data-module-name="{{ $universalBundle->getName() }}">
                    ...
                    @if (!config(strtolower($universalBundle->getName()) . '.name'))
                        <div class="ml-2" data-toggle="tooltip"
                            data-original-title="@lang('app.moduleSwitchMessage', ['name' => $universalBundle->getName()])">
